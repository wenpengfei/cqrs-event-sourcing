...
eventExecutor.on('connected', () => {
    eventExecutor.execute(events_1.default.productAttributeCreated, function (event, message) {
        return __awaiter(this, void 0, void 0, function* () {
            const { version } = event;
            yield makeMysqlClient_1.ProductAttribute.create(Object.assign({}, event.payload, { version }));
        });
    });
});
