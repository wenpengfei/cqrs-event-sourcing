...
eventExecutor.on('connected', () => {
    eventExecutor.execute(events_1.default.productAttributeDeleted, function (event, message) {
        return __awaiter(this, void 0, void 0, function* () {
            const { version } = event;
            const { productAttributeId } = event.payload;
            yield makeMysqlClient_1.ProductAttribute.destroy({ where: { productAttributeId, version: version - 1 } });
        });
    });
});
