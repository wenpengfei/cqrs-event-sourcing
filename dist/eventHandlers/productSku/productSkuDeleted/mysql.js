...
eventExecutor.on('connected', () => {
    eventExecutor.execute(events_1.default.productSkuDeleted, function (event, message) {
        return __awaiter(this, void 0, void 0, function* () {
            const version = event.version;
            const { productSkuId, productId, productSkuItems, stock, price, barCode } = event.payload;
            yield makeMysqlClient_1.ProductSku.destroy({ where: { productSkuId, version: version - 1 } });
            yield makeMysqlClient_1.ProductSkuItem.destroy({ where: { productSkuId } });
        });
    });
});
