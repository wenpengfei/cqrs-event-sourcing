...
const createProduct_1 = require("../../domain/entities/product/createProduct");
...
commandExecutor.on('connected', () => {
    commandExecutor.execute(commands_1.default.createProduct, function (command, message) {
        return createProduct_1.default(command.payload);
    });
});
