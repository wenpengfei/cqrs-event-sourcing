...
const updateProduct_1 = require("../../domain/entities/product/updateProduct");
...
commandExecutor.on('connected', () => {
    commandExecutor.execute(commands_1.default.updateProduct, function (command, message) {
        return updateProduct_1.default(command.payload);
    });
});
